    ...
    useEffect(() => {
        ...
        fetch("https://api.escuelajs.co/api/v1/products")
            ...
            .then(data => {
                ...
                const productosFiltrados = data.filter(producto => producto.category.id === 1); 
    ...
    return (
        <>
            ...
            <div className="container pt-5">
                <h1 className='fs-3'><strong>Vestimenta Hombre</strong></h1>
...
export default VestimentasHombre;
