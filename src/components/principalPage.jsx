...
import calzadosImg from '../images/calzados.jpg'
                    ...
                    <div className="card p-0 m-5 col-11 col-md-5" id='card1'>
                        ...
                        <div className="card-img-overlay d-flex align-items-end justify-content-center">
                            <div>
                                ...
                                <div className='text-center'>
                                    <Link to={'vestimentas'} className="btn btn-outline-light text-center disabled" id='card-btn'><strong>IR AHORA</strong></Link>
                                </div>
                            </div>
                        </div>
                    </div>
